...
var Picker = function () {
	...
	_createClass(Picker, [{
		...
		value: function toggle(show) {
			if (show && this.el.region.val() && this.el.map.val()) this.el.picker.html('<img src="/images/maps/' + this.el.map.val() + '/' + this.el.region.val() + '@1x.png" />').show();else this.el.picker.hide();
		}
	}, {
		key: 'point',
