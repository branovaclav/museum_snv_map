...
var Collection = function () {
	...
	_createClass(Collection, [{
		...
		value: function structurize(fields) {
			...
			if (fields.position && fields.folder) Object.assign(result, {
				position: {
...
var Pois = function (_Collection2) {
	...
	_createClass(Pois, [{
		...
		value: function toggle(id) {
			...
			['map', 'region', 'folder'].forEach(function (field) {
