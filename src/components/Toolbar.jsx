...
const Actions = props => (
	<ul className="actions">
		...
		<li><a className="icon colors" onClick={ props.onLegendClick }></a></li>
...
const Toolbar = props => (
	<section className="toolbar">
		<Actions onHomeClick={ props.onHomeClick } onLegendClick={ props.onLegendClick } onAboutClick={ props.onAboutClick } />
